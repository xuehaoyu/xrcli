...
var createComponentFolder = function createComponentFolder(options) {
  return new Promise(function (resolve, reject) {
    ...
    var stylePath = _path2.default.resolve(componentFolderPath, (folder ? 'index' : component) + '.' + (stateless || 'css'));
    ...
    (0, _fsExtra.lstat)(componentFolderPath, function (error, stats) {
      ...
      if (type === 'class') {
        ...
        (0, _fsExtra.outputFileSync)(componentPath, (0, _reactClassTemplate.reactClassTemplate)(options));
      } else if (type === 'fn') {
      ...
      if (stateless) {
        (0, _print.print)('\u521B\u5EFA\u9ED8\u8BA4' + stateless + '\u6587\u4EF6');
...
var createComponentFile = function createComponentFile(options) {
  return new Promise(function (resolve, reject) {
    ...
    var stylePath = _path2.default.resolve(distPath, component + '.' + (stateless || 'css'));
    ...
    (0, _fsExtra.lstat)(componentFilePath, function (error, stats) {
      ...
      if (type === 'class') {
        (0, _print.print)('创建一个类组件');
        (0, _fsExtra.outputFileSync)(componentFilePath, (0, _reactClassTemplate.reactClassTemplate)(options));
      } else if (type === 'fn') {
        (0, _print.print)('创建一个函数组件');
