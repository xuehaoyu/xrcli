...
var _exportHelperTemplate = require('./exportHelperTemplate');
...
var createComponentFolder = function createComponentFolder(options) {
  return new Promise(function (resolve, reject) {
    ...
    var indexPath = _path2.default.resolve(componentFolderPath, 'index.js');
    var stylePath = _path2.default.resolve(componentFolderPath, component + '.css');
    var componentPath = _path2.default.resolve(componentFolderPath, component + '.' + (typescript ? 'tsx' : 'jsx'));
    ...
    (0, _fsExtra.lstat)(componentFolderPath, function (error, stats) {
      ...
      (0, _print.print)('Creating export helper file');
      (0, _fsExtra.outputFileSync)(indexPath, (0, _exportHelperTemplate.exportHelperTemplate)(component));

      if (stateless) {
        (0, _print.print)('Creating React Stateless Component file');
        (0, _fsExtra.outputFileSync)(componentPath, (0, _reactFnTemplate.reactFnTemplate)(component, true));
      } else {
        (0, _print.print)('Creating React Component Class file');
        (0, _fsExtra.outputFileSync)(componentPath, (0, _reactClassTemplate.reactClassTemplate)(component, true));
      }

      if (includeTest) {
        (0, _print.print)('Creating test file');
        (0, _fsExtra.outputFileSync)(componentTestPath, (0, _jestTestTemplate.jestTestTemplate)(component));
      }

      (0, _print.print)('Creating placeholder CSS file');
...
var createComponentFile = function createComponentFile(options) {
  return new Promise(function (resolve, reject) {
    ...
    (0, _fsExtra.lstat)(componentFilePath, function (error, stats) {
      ...
      if (stateless) {
        (0, _print.print)('Creating React Stateless Component file');
        (0, _fsExtra.outputFileSync)(componentFilePath, (0, _reactFnTemplate.reactFnTemplate)(component, false));
      } else {
        (0, _print.print)('Creating React Component Class file');
        (0, _fsExtra.outputFileSync)(componentFilePath, (0, _reactClassTemplate.reactClassTemplate)(component, false));
      }
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            folder = options.folder, rest = _objectWithoutProperties(options, ['folder']);
            _context.prev = 1;
            ...
            _context.next = 5;
            return createComponentFolder(rest);
          ...
          case 7:
            _context.next = 9;
            return createComponentFile(rest);
