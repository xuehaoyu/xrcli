...
var generate = exports.generate = (0, _command.command)({
  ...
  handler: function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(item, program) {
      var _program$parent, component, directory, type, _program$parent$folde, folder, stateless, _program$parent$types, typescript, options, generator;

      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _program$parent = program.parent, component = _program$parent.component, directory = _program$parent.directory, type = _program$parent.type, _program$parent$folde = _program$parent.folder, folder = _program$parent$folde === undefined ? false : _program$parent$folde, stateless = _program$parent.stateless, _program$parent$types = _program$parent.typescript, typescript = _program$parent$types === undefined ? false : _program$parent$types;
              options = {
                component: component,
                directory: directory,
                type: type,
